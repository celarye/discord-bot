...
impl Runtime {
    ...
    pub async fn initialize_plugins(
        ...
        for plugin in plugins {
            ...
            // TODO: Rethink to prevent duplicate entries
            for interaction_create_message_component in registrations_response
                .discord_events
                .interaction_create
                .message_components
            {
                plugin_registrations
                    ...
                    .insert(
                        ...
                        (plugin.id.clone(), interaction_create_message_component),
                    );
            }

            // TODO: Rethink to prevent duplicate entries
            for interaction_create_modal in registrations_response
                .discord_events
                .interaction_create
                .modals
            {
                plugin_registrations
                    ...
                    .modals
                    .insert(
                        interaction_create_modal.clone(),
                        (plugin.id.clone(), interaction_create_modal),
                    );
            }
